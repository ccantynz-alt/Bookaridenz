  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        title2: 'Transfers',
        subtitle: 'Private shuttle & airport shuttle in one — your own vehicle, your own schedule, door to door across Auckland.',
  ...
  zh: {
    translation: {
      ...
      hero: {
        ...
        title1: '尊贵机场',
        title2: '接送服务',
        subtitle: '私人专车与机场接送二合一 — 专属车辆、专属时间，奥克兰全境门到门服务。',
        bookYourRide: '预订行程',
        viewServices: '查看服务',
        chipInsured: '全面保险',
        chip247: '24/7全天候服务',
  ...
  ja: {
    translation: {
      ...
      hero: {
        ...
        title1: 'プレミアム',
        title2: '空港送迎サービス',
        subtitle: 'プライベートシャトルと空港送迎をひとつに。専用車で、ご希望の時間に、オークランド全域ドア・ツー・ドア。',
        bookYourRide: '予約する',
  ...
  ko: {
    translation: {
      ...
      hero: {
        ...
        title1: '프리미엄 공항',
        title2: '픽업 서비스',
        subtitle: '프라이빗 셔틀과 공항 셔틀을 하나로 — 전용 차량, 원하는 시간, 오클랜드 전역 도어 투 도어.',
        bookYourRide: '예약하기',
        viewServices: '서비스 보기',
  ...
  es: {
    translation: {
      ...
      hero: {
        ...
        subtitle: 'Shuttle privado y traslado al aeropuerto en uno — su propio vehículo, su propio horario, puerta a puerta por todo Auckland.',
  ...
  fr: {
    translation: {
      ...
      hero: {
        ...
        title2: 'Premium',
        subtitle: 'Navette privée et navette aéroport réunies — votre véhicule, votre horaire, porte à porte dans tout Auckland.',
